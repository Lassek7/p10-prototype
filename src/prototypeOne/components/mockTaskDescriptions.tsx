...
export const mockTaskDescriptions = [
    ...
    ,
    {
        taskId: 1,
        taskName: "Task 1",
        taskDescription: "You are looking for Walter who was attending an event at another school in the city but never returned home in the evening. He was last seen departing from the school riding a bike in the late afternoon wearing the following:",
        taskObjectiveOne: "Black winter jacket",
        taskObjectiveTwo: "Blue jeans",
        taskObjectiveThree: "Black gloves",
        taskObjectiveFour: "White bike",
        taskObjectiveFive: "Black bike helmet",
    ...
    ,
    {
        taskId: 2,
        taskName: "Task 2",
        taskDescription: "You are looking for Maria who went hiking with a friend in the morning. They split up midway and agreed to meet up at the endpoint but Maria never showed up. She was last seen on the hiking trail on foot wearing the following:",
    ...
    ,
    {
        ...
        taskObjectiveFive: "Orange transparent water bottle",
        operatorAssignmentOne: "Investigate the detections which could be relevant to the task goals.",
        operatorAssignmentTwo: "Delete the detections which are clearly irrelevant to the task goals.",
