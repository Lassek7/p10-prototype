    ...
    return(
        <Container>
            ...
            <Box sx={{ position: 'absolute', top: "5.55vh", left: "39.47vw", width: '45.26vw', height: '57.2vh'}}>            
                <LargeScreenComponent onDeleteClick={handleDeleteClick} onInvestigateClick={handleInvestigateClick} imageIndex={selectedScreenIndex} detectionsList={AllDetections}/>
            </Box>
            <Box sx={{ position: 'absolute', top: "71.55vh", left: "1.56vw", right: '1.56vw', heigh: '11vh'}}>            
                <ScreensList setScreenIndex={handleLargescreenSwap} detectionsList={AllDetections} selectedScreenIndex={selectedScreenIndex}/>
            </Box>
    </Container>
    )}
