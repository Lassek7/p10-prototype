...
import { initialDetectionsThree, additionalDetectionsThree} from './components/MockData/mockDataDetectionsPrototypeThree' 
...
import { mockDataTaskThreeGoals } from './components/MockData/mockDataTaskGoals'
import { mockDetectionTimerPrototypeThree } from './components/MockData/mockDataDetectionTimer' 
    ...
    useEffect(() => {
        ...
        if(AllDetections.length <= 0) {
            const placeholderDetection = {
                ...
                markedImageUrl: noDetections, //image: image1
